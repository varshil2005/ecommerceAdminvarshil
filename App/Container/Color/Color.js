...
import { addcolor, deletecolor, getColor, updatecolor } from '../Redux/Slice/Color.slice';
      ...
      >
        <View style={style.centeredView}>
          <View style={style.modalView}>
            <Text style={style.modalText}>Add Color Name</Text>
            <TextInput
              name="Color"
